...
impl ServerHandler for AacServer {
    fn get_info(&self) -> ServerInfo {
        ...
        info.server_info.name = "scaffold-mcp".to_string();
        info.server_info.version = VERSION.to_string();
        info.instructions = Some("Scaffold server — use scaffold_inspect to inspect a project, scaffold_onboard to onboard it, scaffold_configure to add skills.".to_string());
        info
    }
